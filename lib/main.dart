...
Future<void> _configureLocalTimeZone() async {
  ...
  print('timeZoneName: $timeZoneName'); //TODO: added print
}
...
class HomePageState extends State<HomePage> {
  ...
  Future<void> _zonedScheduleNotification() async {
    final nowDttm = tz.TZDateTime.now(tz.local).add(const Duration(seconds: 5));
    ...
    await flutterLocalNotificationsPlugin.zonedSchedule(
      ...
      androidScheduleMode:
          AndroidScheduleMode.inexactAllowWhileIdle, //TODO: changed from exact
      uiLocalNotificationDateInterpretation:
          UILocalNotificationDateInterpretation.absoluteTime,
      matchDateTimeComponents: DateTimeComponents.time,
      payload: null,
    );
    //TODO: added print statement
    print('Scheduled: $nowDttm, id: $id');
  }
